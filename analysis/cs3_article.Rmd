---
title: "The Effects of Elevation on Marathons"
subtitle: "ID-Times"
...
```{r histo, fig.align='center', out.width='75%'}
...
<!--
```{r elev, fig.align='center', out.width='75%'}
include_graphics(elevation)
include_graphics(elev)
```
-->

```{r map, fig.align='center', out.width='50%'}
...
```{r gay, fig.align='center', out.width='25%'}
include_graphics(day)
```

```{r temporal, fig.align='center', out.width='75%'}
