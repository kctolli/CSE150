...
```{r links}
top <- 'https://secure.meetupstatic.com/photos/event/d/7/4/b/600_482695115.jpeg'

lifecycle <- 'https://hackernoon.com/drafts/jb2cu3ncx.png'
```

```{r top_pic, fig.align='center', out.width='100%'}
knitr::include_graphics(top)
```
...
knitr::include_graphics(lifecycle)
```
