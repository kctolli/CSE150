...
See [Canvas](https://byui.instructure.com/) for due dates and additional assignments. 
...
Plotly has provided a full suite of [tutorials](https://plotly.com/chart-studio-help/tutorials/) that we can use during the course. Chart Studio is the tool that was used to make the graphics in our textbook. It pretty intuitive and has Plotly has built R and Python packages as well.
